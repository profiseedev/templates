...
#& $profisee_cmd_line_utl /URL:$profisee_svc_uri /IMPORT /TYPE:SUBSCRIBERCONFIGURATION /FILE:$PSScriptRoot\profisee_objects\'SC_Workflow-ProductCreate.subscriberconfig' /CLIENTID:$clientID
